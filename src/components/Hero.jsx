    ...
    <section id="home" className="hero-section d-flex align-items-center">
      <div className="container">
        <div className="row align-items-center">
          {/* Text */}
          <div
            className="col-md-6 d-flex flex-column justify-content-center align-items-center align-items-md-start text-column"
            data-aos="fade-right"
          >
            <div>
              <h1 className="glow-text text-center text-md-start">Hi, I'm Dhanush Kumar</h1>
              <p className="role-text text-center text-md-start">
                <Typewriter
                  words={['Full Stack Developer', 'UX Developer', 'UI Designer']}
                  loop={0}
                  cursor
                  cursorStyle="< />"
                  typeSpeed={100}
              ...
              <div
                ...
                data-aos-delay="200"
              >
                <a href="mailto:dhanushkumar558@gmail.com" className="btn btn-primary glow-btn">
                  Hire Me
                </a>
                <a
